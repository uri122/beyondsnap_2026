...
export default async function CeremonyPage({
  ...
  return (
    <section className="mx-auto max-w-11xl px-4 pt-24 pb-30 sm:px-6 lg:px-12 xl:pt-30">
      ...
      <nav className="mt-20 flex flex-wrap items-center justify-center text-xs md:text-sm font-medium uppercase tracking-wider lg:tracking-widest text-muted-foreground">
        {navItems.map((item, i) => (
